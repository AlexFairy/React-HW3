...
import CharacterDetails from "./ChracterDetail";
import './Marvel.css';
    ...
    return (
        <div>
            {selectedCharacter ? (
                ...
                <div>
                    <h1>Marvel Character Name List!</h1>
                    <div className="character-grid">
                        {characterlist.map((character) => (
                            <div className="character-card" key={character.id} onClick={() => handleImageClick(character)}>
